...
from shop.views import CategoryAPIView, ProductAPIView, ArticleAPIView, UserAPIView, CommandAPIView, UserCreateAPIView, UserUpdateAPIView,TripAPIView,TripCreateAPIView,CommandCreateAPIView
